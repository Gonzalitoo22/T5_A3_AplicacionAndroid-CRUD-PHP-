...
public class AnalizadorJSON {
    ...
    //Metodo peticion iniciar sesion usuarios==========================================================
    public JSONObject peticionHTTPSesion(String url, String metodo, Map datos){
        HttpURLConnection conexion=null;
        URL mUrl =null;
        ...
        try {
            ...
            cadenaJSON = "{\"usuario\":\""+ URLEncoder.encode(String.valueOf(datos.get("usuario")),"UTF-8")+
                    "\",\"contra\":\""+ URLEncoder.encode(String.valueOf(datos.get("contra")),"UTF-8")+"\"}";
            Log.d("MSJ", cadenaJSON);
    ...
    }//metodo para peticion HTTP de usuarios para iniciar sesion
}
